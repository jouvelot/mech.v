...
Definition r (o : O) (i : A) : option 'I_k := o i.
...
(* Sort bids *)
(* Definition apos (b : B) (i : A) : option 'I_k :=
  let pos := index  *)

Definition oStar (b : B): O. 
Admitted.

Definition pos (b : B) : {ffun 'I_k -> A}.
Admitted.

Definition ext k (f : {ffun 'I_k -> nat}) : {ffun 'I_k.+1 -> nat}.
Admitted.

(* TODO: We need to think about how to better represent the castings here *)
Definition price (b : B) (i : A) := 
  let o := oStar b in
  \sum_(j < k.+1 | idx o i < j)
       ext [ffun l => (b \o (pos b)) l] j * 
      (ext [ffun l => (c_prev o \o (pos b)) l] j -
       ext [ffun l => (c o \o (pos b)) l] j).
